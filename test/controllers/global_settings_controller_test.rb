...
class GlobalSettingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create global_setting" do
    assert_difference('GlobalSetting.count') do
      post global_settings_url, params: { global_setting: { active: @global_setting.active, base64_key: @global_setting.base64_key, name: @global_setting.name, url: @global_setting.url } }
    end
  ...
  test "should update global_setting" do
    patch global_setting_url(@global_setting), params: { global_setting: { active: @global_setting.active, base64_key: @global_setting.base64_key, name: @global_setting.name, url: @global_setting.url } }
